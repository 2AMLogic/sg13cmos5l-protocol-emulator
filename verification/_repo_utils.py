...
logic shared by scripts under `verification/` (currently `check_records.py`).
Each script resolves the same `REPO_ROOT` (the parent of `verification/`) and
shells out to `git` against it; centralizing that here means a future change
