module tt_um_2amlogic_protocol_emulator (clk,
 ...
 sg13cmos5l_decap_4 FILLER_34_287 ();
 ...
 sg13cmos5l_decap_4 FILLER_34_363 ();
 sg13cmos5l_fill_2 FILLER_34_367 ();
 ...
 sg13cmos5l_fill_2 FILLER_35_346 ();
 ...
 sg13cmos5l_fill_2 FILLER_37_273 ();
 ...
 sg13cmos5l_decap_8 FILLER_38_194 ();
 ...
 sg13cmos5l_fill_2 FILLER_38_370 ();
 ...
 sg13cmos5l_mux2_1 _08_ (.A0(net32),
    .A1(net3),
    .S(net1),
    .X(_05_));
 sg13cmos5l_mux2_1 _09_ (.A0(net33),
    .A1(net4),
    .S(net1),
    .X(_06_));
 sg13cmos5l_mux2_1 _10_ (.A0(net29),
    .A1(net5),
    .S(net1),
    .X(_07_));
 sg13cmos5l_mux2_1 _11_ (.A0(net28),
    .A1(net6),
    .S(net1),
    .X(_00_));
 sg13cmos5l_mux2_1 _12_ (.A0(net31),
    .A1(net7),
    .S(net1),
    .X(_01_));
 sg13cmos5l_mux2_1 _13_ (.A0(net26),
    .A1(net8),
    .S(net1),
    .X(_02_));
 sg13cmos5l_mux2_1 _14_ (.A0(net27),
    .A1(net9),
    .S(net1),
    .X(_03_));
 sg13cmos5l_mux2_1 _15_ (.A0(net30),
    .A1(net10),
    .S(net1),
    .X(_04_));
 sg13cmos5l_dfrbpq_1 _16_ (.RESET_B(net2),
    .D(_05_),
    .Q(uo_out[0]),
    .CLK(clknet_1_1__leaf_clk));
 sg13cmos5l_dfrbpq_1 _17_ (.RESET_B(net2),
    .D(_06_),
    .Q(uo_out[1]),
    .CLK(clknet_1_1__leaf_clk));
 sg13cmos5l_dfrbpq_1 _18_ (.RESET_B(net2),
    .D(_07_),
    .Q(uo_out[2]),
    .CLK(clknet_1_1__leaf_clk));
 sg13cmos5l_dfrbpq_1 _19_ (.RESET_B(net2),
    .D(_00_),
    .Q(uo_out[3]),
    .CLK(clknet_1_1__leaf_clk));
 sg13cmos5l_dfrbpq_1 _20_ (.RESET_B(net2),
    .D(_01_),
    .Q(uo_out[4]),
    .CLK(clknet_1_0__leaf_clk));
 sg13cmos5l_dfrbpq_1 _21_ (.RESET_B(net2),
    .D(_02_),
    .Q(uo_out[5]),
    .CLK(clknet_1_0__leaf_clk));
 sg13cmos5l_dfrbpq_1 _22_ (.RESET_B(net2),
    .D(_03_),
    .Q(uo_out[6]),
    .CLK(clknet_1_0__leaf_clk));
 sg13cmos5l_dfrbpq_1 _23_ (.RESET_B(net2),
    .D(_04_),
    .Q(uo_out[7]),
    .CLK(clknet_1_0__leaf_clk));
 ...
 sg13cmos5l_dlygate4sd3_1 hold26 (.A(uo_out[5]),
    .X(net26));
 sg13cmos5l_dlygate4sd3_1 hold27 (.A(uo_out[6]),
    .X(net27));
 sg13cmos5l_dlygate4sd3_1 hold28 (.A(uo_out[3]),
    .X(net28));
 sg13cmos5l_dlygate4sd3_1 hold29 (.A(uo_out[2]),
    .X(net29));
 sg13cmos5l_dlygate4sd3_1 hold30 (.A(uo_out[7]),
    .X(net30));
 sg13cmos5l_dlygate4sd3_1 hold31 (.A(uo_out[4]),
    .X(net31));
 sg13cmos5l_dlygate4sd3_1 hold32 (.A(uo_out[0]),
    .X(net32));
 sg13cmos5l_dlygate4sd3_1 hold33 (.A(uo_out[1]),
    .X(net33));
 ...
 sg13cmos5l_buf_1 input9 (.A(ui_in[6]),
    .X(net9));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator (.L_LO(net));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_11 (.L_LO(net11));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_12 (.L_LO(net12));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_13 (.L_LO(net13));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_14 (.L_LO(net14));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_15 (.L_LO(net15));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_16 (.L_LO(net16));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_17 (.L_LO(net17));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_18 (.L_LO(net18));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_19 (.L_LO(net19));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_20 (.L_LO(net20));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_21 (.L_LO(net21));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_22 (.L_LO(net22));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_23 (.L_LO(net23));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_24 (.L_LO(net24));
 sg13cmos5l_tielo tt_um_2amlogic_protocol_emulator_25 (.L_LO(net25));
 assign uio_oe[0] = net;
